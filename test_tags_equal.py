...
class TagsEqualTests(unittest.TestCase):
    ...
    def test_with_multiple_matching_attributes(self):
        self.assertTrue(
            tags_equal("<img width=400 height=200>", "<img width=400 height=200>")
        )
        self.assertFalse(
            tags_equal("<img width=200 height=400>", "<img width=400 height=200>")
        )

    def test_different_order_attributes(self):
        self.assertTrue(
            tags_equal("<img height=200 width=400>", "<img width=400 height=200>")
        )
        self.assertFalse(
            tags_equal("<img height=400 width=200>", "<img width=400 height=200>")
        )

    def test_attributes_with_different_case(self):
        self.assertTrue(tags_equal("<input type=hidden>", "<input TYPE=hidden>"))
        self.assertTrue(tags_equal("<input type=hidden>", "<input Type=hidden>"))
        self.assertFalse(tags_equal("<input type=HIDDEN>", "<input TYPO=HIDDEN>"))
        self.assertFalse(tags_equal("<input type=hidden>", "<input TYPO=hide>"))
    ...
    def test_ignore_duplicate_keys(self):
        self.assertTrue(
            tags_equal("<input type=hidden type=input>", "<input type=hidden>")
        )
        self.assertFalse(
            tags_equal("<img type=input type=hidden>", "<Img type=hidden>")
        )
        self.assertTrue(
            tags_equal("<input TYPE=hidden type=input>", "<input type=hidden>")
        )
    ...
    def test_valueless_keys(self):
        self.assertTrue(
            tags_equal("<input type=checkbox checked>", "<input checked type=checkbox>")
        )
        self.assertFalse(
            tags_equal("<img type=checkbox checked>", "<Img type=checkbox>")
        )
        self.assertTrue(
            tags_equal("<input type=checkbox checked>", "<input type=checkbox CHECKED>")
        )
